...
export function NotFoundPanel({
  ...
  return (
    <section className="relative isolate grid items-center gap-10 py-6 lg:grid-cols-2 lg:gap-16 lg:py-10">
      ...
      <div className="relative mx-auto w-full max-w-[400px] lg:mx-0 lg:ml-auto">
        <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-border-soft shadow-[0_8px_24px_rgb(20_20_40/0.16)]">
          <Image
            src={doorImage}
